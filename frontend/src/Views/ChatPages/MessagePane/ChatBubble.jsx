...
export default function Bubble(props) {
    ...
    return (
        <Box sx={{maxWidth: '60%', minWidth: 'auto'}}>
            <Stack direction="row" spacing={2} sx={MessageStyle.Bubble.Main} onClick={() => console.log(content)}>
                                        ...
                                        {(() => {
                                            ...
                                            return quotedMessage ? (
                                                <Stack direction='column' mb={2}>
                                                    <Typography level="body-sm">{quotedMessage.content}</Typography>
                                                    <Divider/>
                                                </Stack>
                                            ) : null;
                                        })()}
                            ...
                            (contentType === 'file') || (contentType === 'video') || (contentType === 'audio') ? (
                                ...
                                (
                                    <Typography
                                        ...
                                        {/*<br/>*/}
                                        {/*line_quoted_message_id: {line_quoted_message_id}*/}
                                    </Typography>
                                )
                    }
                </Sheet>

...
import { Box, Button, Card, Input, Select, Sheet, Option, Typography, Stack } from "@mui/joy";
        ...
        AlertDiaLog({
            ...
            onPassed: () => {
                if (status === 200) {
                    ...
                    setNewKeyword({ name: null, redirectTo: null });
                }
            }
        })
    }
            ...
            <Box sx={ChatPageStyle.MainContent}>
                ...
                <Grid2 container spacing={2}>
                    <Grid2 size={{ xs: 12, md: 4 }}>
                        <Input placeholder="keyword" onChange={(e) => setNewKeyword({ name: e.target.value, redirectTo: newKeyword.redirectTo })} />
                    </Grid2>
                    <Grid2 size={{ xs: 12, md: 4 }}>
                    ...
                    <Grid2 size={{ xs: 12, md: 4 }}>
                        <Button onClick={() => createKeyword()} disabled={!newKeyword.name || !newKeyword.redirectTo}>
                            บันทึก
                        </Button>
                    </Grid2>
                    <Grid2 size={12}>

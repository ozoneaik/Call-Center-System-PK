...
class NewCase
{
    ...
    public function case($message, $customer, $platformAccessToken, $bot)
    {
        try {
            ...
            // เพิ่มตัวแปรสำหรับวันหยุดเฉลิมพระชนมพรรษาพระบรมราชินี 3 มิถุนายน 2569
            $startQueenBirthday = Carbon::create(2026, 6, 3, 0, 0, 0);
            $endQueenBirthday   = Carbon::create(2026, 6, 3, 23, 59, 59);

            // เพิ่มตัวแปรสำหรับวันหยุด 28 กรกฎาคม 2569
            $startJuly28 = Carbon::create(2026, 7, 28, 0, 0, 0);
            $endJuly28   = Carbon::create(2026, 7, 28, 23, 59, 59);
            ...
            if ($new_rate['latestRoomId'] === 'ROOM00') {
                ...
                // เพิ่มเงื่อนไขตรวจสอบวันหยุดเฉลิมพระชนมพรรษาพระบรมราชินี
                elseif ($now->between($startQueenBirthday, $endQueenBirthday)) {
                    $content = "ขออนุญาตแจ้งวันหยุดเนื่องในวันเฉลิมพระชนมพรรษา สมเด็จพระนางเจ้าสุทิดา พัชรสุธาพิมลลักษณ พระบรมราชินี\n\n";
                    $content .= "บริษัท พัมคิน คอร์ปอเรชั่น จำกัด สำนักงานใหญ่ \n";
                    $content .= "หยุดทำการและงดส่งสินค้า\n\n";
                    $content .= "⭕ วันพุธที่ 3 มิถุนายน 2569\n";
                    $content .= "📅 เปิดทำการ วันพฤหัสบดีที่ 4 มิถุนายน 2569\n\n";
                    $content .= "คุณลูกค้าสามารถพิมพ์ข้อความและสอบถามไว้ได้เลยค่ะ แอดมินจะเร่งตอบกลับในวันเปิดทำการอีกครั้ง ขอบพระคุณค่ะ";
                }
                ...
                // เพิ่มเงื่อนไขตรวจสอบวันหยุด 28 กรกฎาคม 2569
                elseif ($now->between($startJuly28, $endJuly28)) {
                    $content = "📢 แจ้งวันหยุดทำการ\n";
                    $content .= "บริษัท พัมคิน คอร์ปอเรชั่น จำกัด สำนักงานใหญ่\n\n";
                    $content .= "หยุดในวันที่ 28 กรกฎาคม 2569\n";
                    $content .= "เปิดทำการ วันพุธที่ 29 กรกฎาคม 2569\n\n";
                    $content .= "คุณลูกค้ายังสามารถฝากข้อความหรือทำรายการผ่านช่องทางออนไลน์ได้ตลอด 24 ชม. แอดมินจะรีบตอบกลับตามลำดับในวันเปิดทำการ\n";
                    $content .= "ขออภัยในความไม่สะดวก หากมีข้อสงสัยสามารถฝากข้อความไว้ในแชทได้เลยครับ/ค่ะ 🙏";
                } elseif ($now->isSunday() || $now->hour < 8 || $now->hour >= 17) {
                    $content = "พัมคินสวัสดีครับ/ค่ะ 🙏 เนื่องจากขณะนี้เป็นเวลานอกทำการ ต้องขออภัยที่ไม่สามารถให้บริการลูกค้าได้ทันที\n";
                    $content .= "โปรดฝากข้อความและเบอร์ติดต่อกลับ พัมคินจะเร่งติดต่อกลับท่านโดยเร็วที่สุด\n\n";
                    $content .= "บริษัทขออนุญาตแจ้งเวลาทําการคือวันจันทร์-เสาร์ เวลา 08:00-17:00น. หยุดทุกวันอาทิตย์และนักขัตฤกษ์\n";
